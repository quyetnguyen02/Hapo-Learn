            ...
            <div class="row slick">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="feed-back-down">
                        <div class="feed-back-img">
                            <img src="{{asset('app/img/user_avatar.png')}}" alt="Hapo Avatar">
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="feed-back-down">
                        ...
                        <div class="feed-back-down-content">
                            <p class="feed-back-name">Hoang Anh Nguyen</p>
                            <p class="feed-back-span">PHP</p>
                            <p class="feed-back-star">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                ...
                <div class="col-md-6">
                    ...
                    <div class="feed-back-down">
                        <div class="feed-back-img">
                            <img src="{{asset('app/img/user_avatar.png')}}" alt="Hapo Avatar" class="feed-back-img-avt">
                        </div>
                        <div class="feed-back-down-content">
                            <p class="feed-back-name">Hoang Anh Nguyen</p>
                            <p class="feed-back-span">PHP</p>
